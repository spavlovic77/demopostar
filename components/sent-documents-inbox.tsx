...
interface PaginationData {
  ...
  results: SentDocument[]
}

export function SentDocumentsInbox() {
  ...
  const loadDocuments = async () => {
    ...
    try {
      ...
      if (filterOrg !== "all") {
        params.append("filter_sender", filterOrg)
      }

      const response = await fetch(`/api/documents/sent?${params}`, {
        headers: {
    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="border-b bg-card p-4">
        <div className="mb-4 flex items-center justify-between">
          <h1 className="text-2xl font-semibold">Odoslané dokumenty</h1>
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="receiver_identifier">Podľa príjemcu</SelectItem>
        ...
        <Table>
          <TableHeader className="sticky top-0 bg-muted/50">
            <TableRow>
              ...
              <TableHead className="w-[200px]">Príjemca</TableHead>
          ...
          <TableBody>
            {loading ? (
              ...
              documents.map((doc) => (
                <TableRow key={doc.id} className="cursor-pointer transition-colors hover:bg-muted/50">
                  <TableCell>{getStateIcon(doc.state)}</TableCell>
                  <TableCell className="font-medium">
                    <div className="truncate" title={doc.receiver_identifier}>
                      {doc.receiver_name || doc.receiver_identifier}
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation()
                          window.open(`/api/documents/sent/${doc.id}/pdf`, "_blank")
                        }}
                        title="Stiahnuť PDF"
                      >
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation()
                          window.open(`/api/documents/sent/${doc.id}/document`, "_blank")
                        }}
                        title="Stiahnuť XML"
                      >
